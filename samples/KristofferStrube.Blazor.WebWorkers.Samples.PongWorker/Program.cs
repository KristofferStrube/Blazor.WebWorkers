namespace KristofferStrube.Blazor.WebWorkers.Samples.PongWorker
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            WorkerContext.RegisterOnMessage(e =>
            {
                ...
                if (e.GetTypeOfProperty("data") == "string" && e.GetPropertyAsString("data") == "ping")
                {
                    ...
                    WorkerContext.PostMessage("pong");
                    keepRunning = false;
                }
            });

            Console.WriteLine("We are now listening for messages.");
            WorkerContext.PostMessage("ready");
